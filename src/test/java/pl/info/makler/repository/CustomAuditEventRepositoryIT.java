package pl.info.makler.repository;

import pl.info.makler.DevelopersAltkomApp;
import pl.info.makler.config.Constants;
import pl.info.makler.config.audit.AuditEventConverter;
import pl.info.makler.domain.PersistentAuditEvent;
...
import static pl.info.makler.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
