...
import pl.info.makler.domain.Category;
import pl.info.makler.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link pl.info.makler.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
